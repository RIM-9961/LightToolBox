...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def SlotForShowImageInGraphicsView(self):
        if Ui_cameraControl.rawImageUpdate is None:
            ...
            ImageShow = Ui_cameraControl.rawImageUpdateList[0]
            ...
            item = QtWidgets.QGraphicsPixmapItem(QtGui.QPixmap.fromImage(showImage))
            self.scene.clear()
            ...
            self.ui.label_AcqNum.setText(str(Ui_cameraControl.num))
